...
public class WpApiCategoryRepositoryImpl implements CategoryRepository {
    ...
    public WpApiCategoryRepositoryImpl(SyBlogProperties wpProperties, RestTemplateBuilder restTemplateBuilder) {
