...
public class BasicAuthAspect {
    ...
    @Autowired
    private SyBlogProperties properties;

    @Pointcut("@annotation(dev.sunriseydy.blog.common.annotion.BasicAuth)")
