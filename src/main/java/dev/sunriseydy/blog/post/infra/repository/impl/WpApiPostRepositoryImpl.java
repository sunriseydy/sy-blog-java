...
public class WpApiPostRepositoryImpl implements PostRepository, ProxySelf<PostRepository> {
    ...
    public WpApiPostRepositoryImpl(SyBlogProperties wpProperties, RestTemplateBuilder restTemplateBuilder, RedisTemplate<String, Object> redisTemplate) {
    ...
    public void deletePostById(Long id) {
        String key = BlogCacheConstant.getCacheKey(BlogCacheConstant.CACHE_NAME_POSTS) + String.valueOf(id);
